...
class TestUserModel:
    def test_create_user_with_phone_number(self):
        ...
        user = User.objects.create_user(
            phone_number="+420123456789", password="password123"
        )
    ...
    def test_user_roles(self):
        ...
        user = User.objects.create_user(
            phone_number="+420987654321", roles=[Role.PASSENGER, Role.DRIVER]
        )
    ...
    def test_create_superuser(self):
        ...
        admin = User.objects.create_superuser(
            phone_number="+420000000000", password="adminpassword"
        )
...
class TestAccountAPI:
    ...
    def test_login_user(self):
        ...
        User.objects.create_user(
            phone_number="+420555666777", password="testpassword123"
        )

        url = reverse("accounts:login")
        data = {"phone_number": "+420555666777", "password": "testpassword123"}
        response = self.client.post(url, data)
...
class TestDriverAPI:
    def setup_method(self):
        ...
        self.driver_user = User.objects.create_user(
            phone_number="+420444555666", roles=[Role.DRIVER]
        )
