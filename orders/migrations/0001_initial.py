    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "pickup_address",
                    models.CharField(max_length=300, verbose_name="Адреса подачі"),
                ),
                (
                    "dropoff_address",
                    models.CharField(max_length=300, verbose_name="Адреса призначення"),
                ),
                ...
                (
                    "is_pet_friendly",
                    models.BooleanField(default=False, verbose_name="З тваринами"),
                ),
                (
                    "needs_child_seat",
                ...
                (
                    ...
                    models.BooleanField(default=False, verbose_name="Інвалідний візок"),
                ),
                (
                    "status",
                    models.CharField(
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="Прийнято о"
                    ),
                ),
                (
                    "completed_at",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="Завершено о"
                    ),
                ),
                (
                    "dispatcher",
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveSmallIntegerField(
                        help_text="Від 1 до 5", verbose_name="Оцінка"
                    ),
                ),
                ("comment", models.TextField(blank=True, verbose_name="Коментар")),
                (
                    "is_complaint",
                    models.BooleanField(default=False, verbose_name="Це скарга?"),
                ),
