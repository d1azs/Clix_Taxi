...
**CLIX** — це повноцінна платформа для виклику таксі, розроблена як дипломний проєкт. Система складається з:
...
Дипломний проєкт — Львівський національний університет ім. І. Франка, 2026.

---

<p align="center">
  Made with 💜 by <a href="https://github.com/d1azs">d1azs</a>
</p>
